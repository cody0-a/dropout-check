    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('DropOut_case', models.CharField(choices=[('Academic', 'Academic'), ('Financial', 'Financial'), ('Health', 'Health'), ('Personal', 'Personal'), ('marriage', 'marriage'), ('distance', 'distance'), ('death', 'death'), ('other', 'other')], max_length=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('address', models.TextField()),
                ('date_of_birth', models.DateTimeField()),
                ('school', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='account.schoolname')),
